...
child_process_t spawn_pipe(const char *file, char *argv[], int pipe_flags,
                           bool usepath);
child_process_t spawn(const char *file, char *argv[], int pipe_flags,
                      bool usepath, int stdin_fd, int stdout_fd, int stderr_fd);
